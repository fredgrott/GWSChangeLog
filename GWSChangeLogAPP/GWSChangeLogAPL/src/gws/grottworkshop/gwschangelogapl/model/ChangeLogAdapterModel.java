...
public class ChangeLogAdapterModel extends ArrayAdapter<ChangeLogRowModel> {
    ...
    public ChangeLogAdapterModel(Context context,
                            List<ChangeLogRowModel> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ChangeLogRowModel item = getItem(position);
